...
export const BlogCarousel = ({locale}: { locale: string }) => {
    const projects = allBlogs.filter((blog) => blog._raw.flattenedPath.includes(locale)).slice(0, 4);
    ...
    return (
        <section className="my-2">
            ...
            <div className={'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2'}>
                {projects.map((blog) => {
                    return (
                        <Card key={blog.slug} className={'bg-white dark:bg-gray-700 dark:text-white'}>
